...
- 2026-09-16 — 🔍 **FA2D, HRFFA 와 처음으로 같은 자로 비교** — 세 연구 모두 학습하지 않은 LaPa test 에서
  교사 **1.693** · 학생 **1.766** vs HRFFA 2.547
...
![FA2D 어려운 이미지 5장](docs/FA2D/hard5_moderate_concat.jpg)
...
> ⚠ **HRFFA 는 평가셋(WFLW test · 300W · COFW test)을 학습셋에 넣었습니다. 따라서 HRFFA 의 WFLW · 난이도 수치는 정당한 평가가 아닙니다.** HRFFA 와 대등하게 비교할 수 있는 칸은 ② LaPa 뿐입니다.

세 벤치마크 전부 한 표입니다. 모든 값은 실측이며, 참조는 각자의 평가 규약으로 잰 값입니다.
